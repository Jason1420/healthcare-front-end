    ...
    return (
        ...
        h-[100vh] mx-auto ">
            ...
            <div className="med-service-list hidden flex-wrap bg-[#555] justify-around gap-y-3 py-3">
                <div className="serv-item w-[45%] bg-white rounded-sm px-4">Sản phẩm 1</div>
                <div className="serv-item w-[45%] bg-white rounded-sm px-4">Sản phẩm 2</div>
                <div className="serv-item w-[45%] bg-white rounded-sm px-4">Sản phẩm 3</div>
