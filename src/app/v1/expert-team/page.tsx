    ...
    return (
        ...
        h-[100vh] mx-auto ">
            ...
            <div className="med-service-list hidden flex-wrap bg-[#555] justify-around gap-y-3 py-3">
                <div className="serv-item w-[45%] bg-white rounded-sm px-4">Đội ngũ chuyên môn 1</div>
                <div className="serv-item w-[45%] bg-white rounded-sm px-4">Đội ngũ chuyên môn 2</div>
                <div className="serv-item w-[45%] bg-white rounded-sm px-4">Đội ngũ chuyên môn 3</div>
                <div className="serv-item w-[45%] bg-white rounded-sm px-4">Đội ngũ chuyên môn 4</div>
            </div>
            {/* dv suc khoe */}
            ...
            <div className="desktop hidden sm:flex sm:gap-5 h-[100vh]">
                ...
                ">
                    ...
                    <div className="list ">
                        <div className="serv bg-[#f2f2f2] text-right pr-7 py-2 text-[15px] font-semibold text-[#444]">Đội ngũ chuyên môn 1</div>
                        <div className="serv bg-[#f2f2f2] text-right pr-7 py-2 text-[15px] font-semibold text-[#444]">Đội ngũ chuyên môn 2</div>
                        <div className="serv bg-[#f2f2f2] text-right pr-7 py-2 text-[15px] font-semibold text-[#444]">Đội ngũ chuyên môn 3</div>
                        <div className="serv bg-[#f2f2f2] text-right pr-7 py-2 text-[15px] font-semibold text-[#444]">Đội ngũ chuyên môn 4</div>
                    </div>
                    <div className="service bg-[#0e787c] h-[50px] text-[18px] text-white pr-7 justify-end flex items-center font-semibold ">
                        Đội ngũ chuyên môn sức khỏe
                    </div>
