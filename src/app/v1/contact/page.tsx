    ...
    return (
        <div className=" support-page flex flex-col sm:flex-row py-10 mx-auto  sm:w-4/5 ">
            ...
            <div className="left sm:w-[50%] text-center sm:text-start">
                ...
                <div className="form-contact flex flex-wrap justify-between gap-y-3 text-center sm:text-start w-[90%] mx-auto">
            ...
            <div className="right w-[100vw] sm:w-[50%]">
                <iframe className='w-full' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.108167309642!2d106.7194431749824!3d10.803026889347382!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317528a29300e28f%3A0xe559edb53c021dcb!2zMjkyIFVuZyBWxINuIEtoacOqbSwgUGjGsOG7nW5nIDI1LCBCw6xuaCBUaOG6oW5oLCBUaMOgbmggcGjhu5EgSOG7kyBDaMOtIE1pbmggNzAwMDAwLCBWaWV0bmFt!5e0!3m2!1sen!2s!4v1698911674245!5m2!1sen!2s" width="600" height="450" allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div >
    )
}
