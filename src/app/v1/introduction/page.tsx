...
const Introduction = () => {
    return (
        ...
        h-full mx-auto mb-10">
            ...
            <div className="title text-2xl text-[#333] pt-5 hover:text-main-color cursor-pointer pb-2">
                Giới thiệu
            </div>
            <div className="title-1 text-lg text-main-color pl-5">
            ...
            <div className="title-2 text-lg text-main-color pl-5">
            ...
            <div className="title-3 text-lg text-main-color pl-5">
            ...
            <div className="title-4 text-lg text-main-color pl-5">
            ...
            <div className="title-5 text-lg text-main-color pl-5">
